//Al cargar la página, se obtiene y se muestra la edad actualizada dentro de la sección "InformacionPersonal". Luego  se pone a la escucha el check box para el cambio de tema a oscuro.
